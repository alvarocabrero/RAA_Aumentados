...
public class LockedDoorMovement : MonoBehaviour
{
    ...
    // Si, habiendo recogido la llave, el jugador está dentro del collider y pulsa el botón
    // indicado, la puerta se abre o cierra.
